...
;(function(window) {
	...
	var bodyEl = document.body, 
		...
		scrollContainerr = document.querySelector('.containerr'),
	...
	function openItem(item) {
		...
		// disallow scroll
		scrollContainerr.addEventListener('scroll', noscroll);
		// apply transforms
	...
	function closeContent() {
		...
		onEndTransition(contentItem, function(ev) {
			...
			lockScroll = false;
			scrollContainerr.removeEventListener('scroll', noscroll);
	...
	// disallow scrolling (on the scrollContainerr)
	function noscroll() {
		if(!lockScroll) {
			lockScroll = true;
			xscroll = scrollContainerr.scrollLeft;
			yscroll = scrollContainerr.scrollTop;
		}
		scrollContainerr.scrollTop = yscroll;
		scrollContainerr.scrollLeft = xscroll;
	}
